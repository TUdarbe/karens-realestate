...
export const metadata: Metadata = {
  title: "About Karen | RE/MAX Real Estate",
    ...
    <>
      ...
      <section className="bg-navy py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white">About Karen</h1>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start gap-6">
              ...
              <div className="bg-sky rounded-xl p-6 w-72 md:w-80">
                ...
                <ul className="space-y-3 text-sm">
                  <li>
                    <a href="tel:+1XXXXXXXXXX" className="flex items-center gap-3 text-steel hover:text-navy transition-colors font-semibold">
                      <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                      (XXX) XXX-XXXX
                    </a>
                  </li>
                  <li>
                    <a href="mailto:karen@example.com" className="flex items-center gap-3 text-steel hover:text-navy transition-colors font-semibold">
                  ...
                  <li className="text-slate-400 text-xs pt-1">License #XXXXXXX · RE/MAX [Office Name]</li>
                </ul>
              </div>
            </div>
            ...
            {/* Bio Text */}
            <div>
              <p className="text-steel text-xs font-bold uppercase tracking-widest mb-2">RE/MAX [Office Name]</p>
              <h2 className="text-3xl md:text-4xl font-black text-navy mb-6">Karen [Last Name]</h2>
