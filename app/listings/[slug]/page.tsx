        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-navy rounded-2xl p-7 text-white border-t border-steel/30">
              ...
              <h3 className="text-2xl font-black mb-1">Karen [Last Name]</h3>
              <p className="text-slate-400 text-sm mb-6">RE/MAX [Office Name]</p>
              ...
              <p className="text-slate-400 text-xs mt-5 text-center">License #XXXXXXX</p>
            </div>
          </div>
        </div>
      </div>
